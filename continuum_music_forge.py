    ...
    if backend_key in {"ace_step_v15", "acestep_v15", "ace_v15", "ace_step"}:
        return {
            ...
            "args": [
                ...
                "apg",
                10.0,
                None if int(seed) < 0 else str(int(seed)),
                0.5,
                0.0,
                3.0,
                True,
            ...
            "notes": "ACE-Step v1.5 returns an audio filepath plus generation parameters.",
        }
...
def generate_music_preset(
    ...
    return generate_hf_space_song(
        ...
        payload_json=json.dumps(
            {"api_name": preset["api_name"], "args": preset["args"], "title": title or prompt[:80]},
            ensure_ascii=False,
        ),
