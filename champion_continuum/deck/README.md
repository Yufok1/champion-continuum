...
- Hugging Face Inference Providers via the optional `HF Inference Providers -
  ...
  forum name, or by starting the verified provider scout pack:
  ...
  account-credit-gated stay out of the default pack. Use `--include-unverified`
  only when you want to try additional chat-capable catalog providers; some live
  provider/model pairs may fail.
